...
@section('content')
    <div class="card">
        <div class="card-header">Data Matkul</div>
        <div class="card-body">
            <a href="{{ route('matkuls.create') }}" class="btn btn-primary mb-2">Tambah Data</a>
